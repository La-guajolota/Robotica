...
def run_streamlit_dashboard():
    ...
    try:
        subprocess.run([sys.executable, "-m", "streamlit", "run", r"C:\Users\daniS\OneDrive\Desktop\Robotica-Melchor\Dashboard_PROYECTO\dashboard.py", "--server.port=8501"])
    except Exception as e:
...
def main():
    ...
    required_files = [r"C:\Users\daniS\OneDrive\Desktop\Robotica-Melchor\Dashboard_PROYECTO\dashboard.py", r"C:\Users\daniS\OneDrive\Desktop\Robotica-Melchor\Dashboard_PROYECTO\conector_PLC.py", r"C:\Users\daniS\OneDrive\Desktop\Robotica-Melchor\Dashboard_PROYECTO\config.py"]
