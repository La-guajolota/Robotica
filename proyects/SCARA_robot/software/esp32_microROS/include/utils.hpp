...
/*
Uncomment the following line to enable TCA9548A I2C multiplexer support or
 ...
 */
// 6400 steps per revolution (1/32 microstepping mode)
// 3200 steps per revolution (1/16 microstepping mode)
// 1600 steps per revolution (1/8 microstepping mode)
// 400 steps per revolution (1/2 microstepping mode)
// 200 steps per revolution (full step mode)
#define BASE_MOTOR_STEPS 400
#define LINKS_MOTOR_STEPS 400
